...
internal fun SectionCard(
    ...
    // Defaults to the uniform 12dp inner padding every card shares. Keep the
    // sides at 12dp in any override so the card stays on the same left/right
    // rhythm as its siblings.
