...
internal fun TypeLauncherApp(
    ...
    TypeLauncherApp(
        ...
        onWidgetPaddingRemovedChanged = viewModel::setWidgetPaddingRemoved,
    ...
    Scaffold(
        ...
        if (state.isSettingsOpen) {
            SettingsScreen(
                ...
                onWidgetPaddingRemovedChanged = onWidgetPaddingRemovedChanged,
            ...
            SwipeNavigationBox(
                ...
                when (pageScreen) {
                    ...
                    LauncherScreen.Widgets -> WidgetsScreen(
                        ...
                        removeWidgetPadding = state.isWidgetPaddingRemoved,
                        onAddWidget = onAddWidget,
                        onDismissWidgetPicker = onDismissWidgetPicker,
                        onSelectWidget = onSelectWidget,
                        onRemoveWidget = onRemoveWidget,
