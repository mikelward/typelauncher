 ...
 * while the carousel is transitioning. A user-forced tray open can still render
 * during the pending auto-keyboard window, but only until the keyboard actually
 * shows or starts animating in.
 */
